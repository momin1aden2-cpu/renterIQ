...
// Replace Header
text = text.replace(
    /<h1>The ultimate renting intelligence.<br>Built for the modern tenant.<\/h1>\s*<p class="hero-sub">Track inspections, verify condition reports, and securely analyze your lease with AI. Everything you need to secure your bond and rent confidently — right in your pocket.<\/p>/g,
...
// Replace phone-wrap
const phoneWrapReplacement = `<div class="carousel-container" style="display: flex; align-items: center; gap: 16px; margin: 0 auto; z-index: 2;">
...
text = text.replace(/<div class="phone-wrap">[\s\S]*?<\/div>\s*<\/div>\s*<\/section>/, phoneWrapReplacement + '\\n  </div>\\n</section>');
...
text = text.replace(/<\/body>/, scriptToAdd);
